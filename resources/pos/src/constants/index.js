...
export const apiBaseURL = {
    ...
    CASH_ADVANCE_IDENTITIES: "/cash-advance-identities",
...
export const cashAdvanceIdentityActionType = {
    FETCH_CASH_ADVANCE_IDENTITIES: "FETCH_CASH_ADVANCE_IDENTITIES",
    FETCH_CASH_ADVANCE_IDENTITY: "FETCH_CASH_ADVANCE_IDENTITY",
    ADD_CASH_ADVANCE_IDENTITY: "ADD_CASH_ADVANCE_IDENTITY",
    EDIT_CASH_ADVANCE_IDENTITY: "EDIT_CASH_ADVANCE_IDENTITY",
    DELETE_CASH_ADVANCE_IDENTITY: "DELETE_CASH_ADVANCE_IDENTITY",
    FETCH_ACTIVE_IDENTITIES_FOR_SELECT: "FETCH_ACTIVE_IDENTITIES_FOR_SELECT",
    FETCH_IDENTITIES_WITH_SUMMARY: "FETCH_IDENTITIES_WITH_SUMMARY",
};
...
export const Permissions = {
    ...
    MANAGE_PRODUCT_DIGITALS: "manage_product_digitals",
    ...
    CREATE_PRODUCT_DIGITALS: "create_product_digitals",
    VIEW_PRODUCT_DIGITALS: "view_product_digitals",
    EDIT_PRODUCT_DIGITALS: "edit_product_digitals",
    DELETE_PRODUCT_DIGITALS: "delete_product_digitals",
