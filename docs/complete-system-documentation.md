...
- **Multi-tenancy Support**: Supports multiple stores/tenants on a single installation
- **Multi-language**: Supports 10+ languages including English, Arabic, Chinese, French, German, Indonesian, Spanish, Turkish, and Vietnamese
- **Multi-currency**: Supports multiple currencies with automatic conversion
- **Role-based Access Control**: Comprehensive permission system for different user roles
- **Payment Gateway Integration**: Supports Stripe, PayPal, Razorpay, and Paystack
- **Barcode Generation**: Built-in barcode generation for products
- **PDF Reports**: Generate PDF reports for sales, purchases, and other transactions
- **Excel Import/Export**: Bulk import/export functionality for products, customers, and suppliers
...
- **Multi-language Support**: 10+ language support
...
- **API Documentation**: Built-in API with proper documentation
- **File Storage**: AWS S3 integration
- **Payment Processing**: Stripe, PayPal, Razorpay, Paystack
...
# Create tenant
php artisan tenants:create --name="Store Name" --email=store@example.com
```
...
### Version History
- **v1.2.0**: Current version with multi-tenancy support
...
*This documentation was last updated on: 2025-10-17*
